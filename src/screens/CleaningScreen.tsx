...
export default function CleaningScreen() {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      {/* Modals */}
      <ConfirmModal visible={showNotYourTurn} title="לא התורה שלך" message="כרגע זה לא התורה שלך לנקות" confirmText="הבנתי" cancelText="" onConfirm={() => setShowNotYourTurn(false)} onCancel={() => setShowNotYourTurn(false)} />
