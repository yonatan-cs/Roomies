...
This is a custom asset generation service that uses a custom API endpoint maintained by Roomies. If the user wants to build an app that generates images, assets, icons, or anything else, you must use this internal endpoint. Do not attempt to use replicate or chatgpt.
...
const baseUrl = "https://api.Roomiesapp.com";
